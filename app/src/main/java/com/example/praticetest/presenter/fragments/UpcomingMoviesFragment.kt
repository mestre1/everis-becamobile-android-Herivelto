...
import com.example.praticetest.presenter.adapters.UpcomingMoviesPagingAdapter
...
class UpcomingMoviesFragment : Fragment() {
    ...
    private lateinit var listAdapter: UpcomingMoviesPagingAdapter
    ...
    override fun onCreateView(
        ...
        binding.moviesTopRatedTextView.text = getString(R.string.upcoming)
        return binding.root
    }
    ...
    private fun setRecyclerView() {
        listAdapter = UpcomingMoviesPagingAdapter() { movie -> goToMovieDetails(movie) }
